...
public class RiversController {
    ...
    void doPopola(ActionEvent event) {
    	...
    	Result result = model.popola(river);
    	if(result!=null) {
    		txtStartDate.setText(result.getDataPrima().toString());
    		txtEndDate.setText(result.getDataUltima().toString());
    		txtNumMeasurements.setText(String.format("%d",result.getNumeroMisurazioni()));
    		txtFMed.setText(String.format("%f", result.getMediaFlusso()));
    ...
    void doSimula(ActionEvent event) {
    	...
    	txtResult.appendText("Capienza media : "+nf.format(model.mediaCapienza())+"\n");
    	txtResult.appendText("Giorni in cui non si e' garantita l'erogazione minima : "+model.mancati()+"\n");
